...
import { Zap, Activity, Bot, GitMerge } from 'lucide-react'; // Example icons

const logos = [
  { icon: <Zap size={40} />, name: 'Zapier' },
  { icon: <Activity size={40} />, name: 'Stripe' },
  { icon: <Bot size={40} />, name: 'PayPal' },
  { icon: <GitMerge size={40} />, name: 'Google Drive' },
];
