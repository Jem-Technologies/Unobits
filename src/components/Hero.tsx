    ...
    <section className="relative overflow-hidden bg-white dark:bg-black text-center py-20 md:py-32 px-4 flex flex-col items-center">
      ...
      <div className="z-10 flex flex-col items-center">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
          <a href="#" className="w-full md:w-auto bg-neon-teal hover:bg-opacity-80 text-black px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-transform duration-200 hover:scale-105">
            <span>Start Using UNOBITS Free</span>
            <ArrowRight size={20} />
          </a>
          <a href="#" className="w-full md:w-auto bg-slate-100 dark:bg-slate-800 text-headings dark:text-white px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-transform duration-200 hover:scale-105">
            <PlayCircle size={20} />
            <span>See the Ecosystem</span>
          </a>
        </div>
        <div className="mt-12">
          <p className="text-sm text-body-copy dark:text-slate-500">Trusted by forward-thinking companies.</p>
          <div className="flex flex-wrap justify-center items-center mt-4 space-x-6 md:space-x-10 opacity-50 grayscale">
            <p className="font-mono">Logo1</p>
            <p className="font-mono">Logo2</p>
            <p className="font-mono">Logo3</p>
            <p className="font-mono">Logo4</p>
            <p className="font-mono">Logo5</p>
          </div>
        </div>
      </div>
