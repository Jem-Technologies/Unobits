        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-body-copy dark:text-slate-400">
              Built to keep context connected — so work moves forward without tab switching.
            </p>
          </div>
          <div className="mt-16 space-y-16">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-gray-100 dark:bg-slate-800">
                  <Image
