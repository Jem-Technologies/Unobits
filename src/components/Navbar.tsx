        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/integrations" className="text-body-copy dark:text-slate-300 hover:text-neon-teal transition-colors">Integrations</Link>
              ...
              <Link href="/help-center" className="text-body-copy dark:text-slate-300 hover:text-neon-teal transition-colors">Help</Link>
            </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full space-y-8">
              ...
              <Link href="/integrations" onClick={closeAllModals} className="text-2xl text-headings dark:text-white">Integrations</Link>
              ...
              <Link href="/help-center" onClick={closeAllModals} className="text-2xl text-headings dark:text-white">Help</Link>
